            ...
            if (jsonStr != null){
                try {
                    ...
                    for (int i = 0; i < contacts.length(); i++) {
                        ...
                        JSONObject mobile = c.getJSONObject("mobile");
                        JSONObject home = c.getJSONObject("home");
                        JSONObject office = c.getJSONObject("office");
                        ...
                        contact.put("mobile", String.valueOf(mobile));
